...
class estoque(ctk.CTk):
    ...
    def controles_estoque(self):
        ...
        self.label_tamanho = CTkLabel(self.frame_controle, text="Tamanho")
        ...
        self.label_qtd = CTkLabel(self.frame_controle, text="Nova quantidade")
        self.label_qtd.pack(pady=(15,5))
